...
class RideService {
    ...
    async createRide(userId, data) {
        ...
        await this.eventPublisher.publishRideRequested({ rideId: ride.rideId, vehicleType: ride.vehicleType, pickupAddress: ride.pickupAddress, estimatedFare: ride.estimatedFare })
        return ride
    }
    ...
    async acceptRide(rideId, userId) {
        ...
        const updatedRide = await this.rideRepository.updateState(rideId, "ACCEPTED", {
