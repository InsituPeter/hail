...
describe("RideService.acceptRide()", ()=>{
  ...
  it("Accepts ride successfully", async()=>{
    ...
    rideRepository.updateState.mockResolvedValue({...ride, state:"ACCEPTED", driverProfileId:driver.driverProfileId, acceptedAt: new Date("2024-11-26")})
   ...
   expect(rideRepository.updateState).toHaveBeenCalledWith(ride.rideId, "ACCEPTED", expect.objectContaining({
        driverProfileId:driver.driverProfileId
    }))
  })
})
