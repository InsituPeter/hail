...
const { authController, webhookController, driverController, authService, riderController, rideController } = require("./container")
...
initializeSocket(server, authService, redis)
